...
if(isset($_GET['page'])){
	...
	*/
	...
	function easyreservations_get_emails(){
		$emails = array(
			'reservations_email_sendmail'			  			=> array('name' => __('Mail to guest from admin in dashboard', 'easyReservations'), 'option' => get_option('reservations_email_sendmail'), 'name_subj' => 'reservations_email_sendmail_subj', 'name_msg' => 'reservations_email_sendmail_msg', 'standard' => '0', 'name_active' => 'reservations_email_sendmail_check'),
			'reservations_email_to_user'							=> array('name' => __('Mail to guest after new reservation', 'easyReservations'), 'option' => get_option('reservations_email_to_user'), 'name_subj' => 'reservations_email_to_user_subj', 'name_msg' => 'reservations_email_to_user_msg', 'standard' => '4', 'name_active' => 'reservations_email_to_user_check'),
			'reservations_email_to_userapp'						=> array('name' => __('Mail to guest after approval', 'easyReservations'), 'option' => get_option('reservations_email_to_userapp'), 'name_subj' => 'reservations_email_to_userapp_subj', 'name_msg' => 'reservations_email_to_userapp_msg', 'standard' => '2', 'name_active' => 'reservations_email_to_userapp_check'),
			'reservations_email_to_userdel'						=> array('name' => __('Mail to guest after rejection',  'easyReservations'), 'option' => get_option('reservations_email_to_userdel'), 'name_subj' => 'reservations_email_to_userdel_subj', 'name_msg' => 'reservations_email_to_userdel_msg', 'standard' => '3', 'name_active' => 'reservations_email_to_userdel_check'),
			'reservations_email_to_user_admin_edited'	=> array('name' => __('Mail to guest after admin edited',  'easyReservations'), 'option' => get_option('reservations_email_to_user_admin_edited'), 'name_subj' => 'reservations_email_to_user_admin_edited_subj', 'name_msg' => 'reservations_email_to_user_admin_edited_msg', 'standard' => '7', 'name_active' => 'reservations_email_to_user_admin_edited_check'),
			'reservations_email_to_admin'				  		=> array('name' => __('Mail to admin after new reservation',  'easyReservations'), 'option' => get_option('reservations_email_to_admin'), 'name_subj' => 'reservations_email_to_admin_subj', 'name_msg' => 'reservations_email_to_admin_msg', 'standard' => '1', 'name_active' => 'reservations_email_to_admin_check'),
		);
